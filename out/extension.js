...
function activate(context) {
    ...
    context.subscriptions.push(vscode.commands.registerCommand('deepseek.openChat', () => {
        const panel = vscode.window.createWebviewPanel('deepseekChat', // ID
        'DeepSeek Chat', // Title
    ...
    context.subscriptions.push(vscode.commands.registerCommand('deepseek.sendCode', () => {
        ...
        if (editor) {
            ...
            const panel = vscode.window.createWebviewPanel('deepseekChat', 'DeepSeek Chat', vscode.ViewColumn.One, {
                enableScripts: true,
